...
<link rel="pingback" href="http://www.creepypixel.com/xmlrpc.php" />
<!--[if lt IE 9]>
...
<link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://www.creepypixel.com/xmlrpc.php?rsd" />
			...
			<hgroup>
				...
				<h2 id="site-description">Just another WordPress site</h2>
						...
						<a href="../../../default.htm">
								...
								<form method="get" id="searchform" action="http://www.creepypixel.com/">
	...
	<div id="primary">
		...
		<input type="submit" class="submit" name="submit" id="searchsubmit" value="Search" />
				...
				<li><a href="../../../hello-world/default.htm" title="Hello world!">Hello world!</a></li>
					...
					<div class="widget widget_archive"><h2 class="widgettitle">Archives</h2><p>Try looking in the monthly archives.  <img src='../../../wp-includes/images/smilies/icon_smile.gif' alt=':)' class='wp-smiley' /> </p>		<select name="archive-dropdown" onchange='document.location.href=this.options[this.selectedIndex].value;'> <option value="">Select Month</option> 	<option value='../../../2012/08/default.htm'> August 2012 </option>
 </select>
</div>
