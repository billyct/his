<?php include_once __DIR__."/../dashboard/header.php" ?>
    ...
    <nav id="sidebar">
        ...
        <ul class="nav" id="main_nav">
            ...
            <li ><a href="<?php echo base_url('doctor/work') ?>" class="page_link" dataid="page_work">医生工作站</a></li>
        </ul> <!-- /Nav menu -->
...
<script type="text/javascript" src="<?php echo base_url('js/functions/doctor-functions.js') ?>"></script> 
