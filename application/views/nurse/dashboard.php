<?php include_once __DIR__."/../dashboard/header.php" ?>
    ...
    <nav id="sidebar">
        ...
        <ul class="nav" id="main_nav">
            ...
            <li ><a href="<?php echo base_url('nurse/reg') ?>" class="page_link" dataid="page_reg">挂号</a></li>
            <li ><a href="<?php echo base_url('nurse/drug') ?>" class="page_link" dataid="page_drug">开药管理</a></li>
...
<script type="text/javascript" src="<?php echo base_url('js/functions/nurse-functions.js') ?>"></script> 
